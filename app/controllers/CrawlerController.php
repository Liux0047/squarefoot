...
class CrawlerController extends BaseController
{
    ...
    private $seriesEnd = 200;    //actually 700
    private $seriesInterval = 10;
    ...
    */
    ...
    public function getData($batch = 0)
    {
        ...
        for ($series = $this->seriesStart; $series < $this->seriesEnd; $series += $this->seriesInterval) {
            ...
            $options = array(
                ...
                CURLOPT_COOKIE => '4c58ce487e2c2608deb11d56b844b0c1=b6ae55a1434bd31e1119cb6687d84fedX; path=/; domain=www.squarefoot.com.sg; Secure',
                CURLOPT_POST => 1,
        ...
        $records = array();
        foreach ($cUrls as $ch) {
            echo $this->extractData(curl_multi_getcontent($ch['curl']), $ch['series']);
    ...
    private function extractData($html, $series)
    {
        return $html;
